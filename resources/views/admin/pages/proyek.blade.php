                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="{{ asset("image_proyek/$view_proyek->foto_proyek") }}" width="220" height="220" alt="">
                            </div>
                            <div class="card-footer">
                                <div class="d-flex justify-content-center">

                                    <a href="/editproyek" class="btn btn-warning"><i
                                            class="fa-regular fa-pen-to-square"></i>edit </a>
                                    <a href="#" class="btn btn-dark"><i class="fa-solid fa-trash"></i>Hapus</a>
                                </div>
